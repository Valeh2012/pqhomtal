...
PQMX={'series':'PQMX','name':1,'parameter':{'n':4096,'q':4611686018427365377,'s':1,'mm':4096},'distribution':{0:1/2,1:1/4,2:1/4}}
PQHT={'series':'PQHX','name':1,'parameter':{'n':2048,'q':1073479681,'s':1,'mm':2048},'distribution':{0:1/3,1:1/3,2:1/3}}
...
PQMX_attack=dual_guess_estimation(PQHT,costmodel)
